  ...
  head: () => ({
    meta: [
      { title: "Keunggulan — Baboo.id" },
      {
        name: "description",
        content:
          "Respons 24/7, hemat biaya operasional, mudah diintegrasikan, dan dapat dikustomisasi sesuai industri.",
      },
...
const items = [
  {
    icon: Clock,
    title: "Respons 24/7",
    desc: "Pelanggan terlayani kapan saja, termasuk akhir pekan dan hari libur.",
  },
  {
    icon: Wallet,
    title: "Hemat biaya operasional",
    desc: "Kurangi beban kerja tim, alokasikan SDM untuk hal yang lebih strategis.",
  },
  {
    icon: Plug,
    title: "Mudah diintegrasikan",
    desc: "Terhubung dengan WhatsApp, website, CRM, dan tools yang sudah Anda pakai.",
  },
  {
    icon: Settings,
    title: "Bisa dikustomisasi",
    desc: "AI Agent disesuaikan dengan brand, produk, dan alur kerja perusahaan.",
  },
  {
    icon: Globe,
    title: "Bahasa Indonesia natural",
    desc: "Memahami konteks lokal dan gaya percakapan pelanggan Indonesia.",
  },
  {
    icon: ShieldCheck,
    title: "Aman & terkendali",
    desc: "Anda tetap punya kendali penuh atas data dan respons AI.",
  },
];
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((i) => (
            <div
              key={i.title}
              className="rounded-2xl border border-border bg-card p-6 transition hover:-translate-y-1 hover:shadow-soft"
            >
